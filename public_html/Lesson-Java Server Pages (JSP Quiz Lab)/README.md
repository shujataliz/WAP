...
This lab assignment shows important JSP ideas and 
the Model 2 web design, where business logic is kept 
separate from the presentation. 

This project helps me hands-on practice with taking user input, 
checking the data, and creating a scoring system with 
